...
<section>
    <div class="container" style="margin-top: 1cm">
            ...
            <form class="form-inline" action="list.do">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="구 입력             (예)강남구" name="district">
                    </div>
        ...
        <table class="table table-striped table-bordered table-hover" width="100%">
            ...
            <c:forEach items="${library_list}" var="a">
                <tr class="success">
                    <td width="10%">"${a.name}"</td>
                    <td width="12%">${a.address}</td>
                    <td width="7%">${a.phone }</td>
                    <td width="8%">${a.homepage }</td>
                    <td width="10%">${a.holiday }</td>
                </tr>
            </c:forEach>
        </table>
    </div>
