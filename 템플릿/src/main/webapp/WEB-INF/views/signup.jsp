      ...
      <div class="col-md-6 col-md-offset-3 col-sm-6 col-sm-offset-3">
        <div class="block">
          ...
          <div class="contact-form">
            <form:form id="contact-form" modelAttribute="user" role="form">
              ...
              <div id="submit" class="wow fadeInDown" data-wow-duration="500ms" data-wow-delay=".8s">
                <input type="submit" id="contact-submit" class="btn btn-default btn-send" value="Signup">
              </div>
            </form:form>
          </div>
        </div>
