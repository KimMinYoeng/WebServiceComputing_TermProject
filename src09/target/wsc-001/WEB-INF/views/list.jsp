        ...
        <div class="block">
          ...
          <div class="contact-form">
            <form id="contact-form" method="post" action="sendmail.php" role="form">
              ...
              <wrap>
                <div>
                  <a id = "login" class = "wow fadeInDown" data-wow-duration="500ms"data-wow-delay="1.4s"
                     input type = "submit" class="btn btn-default btn-send" href="#search" data-section="#search" >login</a>
                  <a id = "join" class = "wow fadeInDown" data-wow-duration="500ms"data-wow-delay="1.4s"
                     input type = "submit" class="btn btn-default btn-send" href="#search" data-section="#search" >join</a>
                </div>
