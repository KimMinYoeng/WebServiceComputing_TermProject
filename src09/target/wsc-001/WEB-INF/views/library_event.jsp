...
<section>
    <div class="container" style="margin-top: 1cm">
        <center>
            <form class="form-inline" action="event.do">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="구 입력            (예)강남구" name="district_event">
                    </div>
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="도서관명 입력" name="library_event">
                    </div>
