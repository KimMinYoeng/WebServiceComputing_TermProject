...
<section>
    <div class="container" style="margin-top: 1cm">
        <center>
            <form class="form-inline" action="education.do">
                <div class="form-group">
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="구 입력            (예)강남구" name="district_service">
                    </div>
                    <div class="input-group">
                        <input type="text" class="form-control" placeholder="도서관명 입력" name="library_service">
                    </div>
        ...
        <table class="table table-striped table-bordered table-hover" width="100%">
            ...
            <c:forEach items="${library_education}" var="a">
                <tr class="success">
    ...
    <div class="container">
        <div class="col-md-8">
            <p class="copyright">Copyright: <span>2017</span> . Design and Developed by <a
                    href="https://github.com/KimMinYoeng/WebServiceComputing_TermProject">wsc termproject team</a></p>
        </div>
        <div class="col-md-4">
            <!-- Social Media -->
            <ul class="social">
