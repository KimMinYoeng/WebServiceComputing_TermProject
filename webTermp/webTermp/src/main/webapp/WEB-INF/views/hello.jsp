            ...
            <div class="col-md-12 text-center">
                <div class="block wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <sec:authorize access="isAnonymous()">
                        <h2>우리 서비스는 로그인을 하셔야지만 이용할 수 있습니다.</h2>
                        <h2>아직 회원이 아닌신 경우 'JOIN'을 눌러 가입 해주세요.</h2>
                        <a class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green"
                           data-wow-delay=".9s" href="/user/singin">SIGNIN</a>
                        <a class="btn-lines dark light wow fadeInUp animated smooth-scroll btn btn-default btn-green"
                           data-wow-delay=".9s" href="/user/signup">JOIN</a>
                    </sec:authorize>
