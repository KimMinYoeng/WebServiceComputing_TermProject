    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td>&nbsp event.library &nbsp</td>
                    <td>&nbsp 도서관 명&nbsp</td>
                </tr>
                <tr>
    ...
    <div class="container">
        <div class="row">
            ...
            <table class="table table-striped table-bordered table-hover">
                ...
                <tr>
                    <td rowspan="2"> 입력값</td>
                    <td>&nbsp district_education &nbsp</td>
                    <td>&nbsp 지역 단위(구)&nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp library_education &nbsp</td>
                    <td>&nbsp 도서관명 &nbsp</td>
                </tr>
                <tr>
                    <td rowspan="6"> 출력값</td>
                    <td>&nbsp educaion.name &nbsp</td>
                    <td>&nbsp 강좌명&nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp education.library &nbsp</td>
                    <td>&nbsp 도서관 명&nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp education.begindate &nbsp</td>
                    <td>&nbsp 강좌 시작 날짜&nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp education.enddate &nbsp</td>
                    <td>&nbsp 강좌 종료 날짜 &nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp education.target &nbsp</td>
                    <td>&nbsp 대상 &nbsp</td>
                </tr>
                <tr>
                    <td>&nbsp education.place &nbsp</td>
                    <td>&nbsp 강좌 장소 &nbsp</td>
                </tr>
            </table>
        </div>
    </div>
