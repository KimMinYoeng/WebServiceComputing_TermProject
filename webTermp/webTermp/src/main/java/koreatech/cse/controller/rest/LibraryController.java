...
public class LibraryController {
    ...
    public ModelAndView education(@RequestParam(required=false)String district_service, @RequestParam(required=false)String library_service){
        ModelAndView mav = new ModelAndView();
        if((district_service != ""  && library_service != "") || (district_service != "" && library_service == ""))
            mav.addObject("library_education", educationService.serachEducation(district_service, library_service));
        else
            mav.addObject("library_education", null);

        mav.setViewName("library_education");
